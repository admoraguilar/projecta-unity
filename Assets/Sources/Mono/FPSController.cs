...
/// <summary>
/// Modified Unity Standard Assets FPS Controller script.
/// </summary>
public class FPSController : MonoBehaviour
{
    ...
    [Inject, SerializeField] private FPSControllerMouseLook m_MouseLook = new FPSControllerMouseLook();
    ...
    private void Awake() {
        //Main.InitializeObject(m_MouseLook);
    }
    ...
    private void Update()
    {
        ...
        GameData.Transient.Player.JumpInput = m_Jumping;
        GameData.Transient.Player.MoveVerticalInput = m_Input.y;
    }
    ...
    private void GetInput(out float speed)
    {
        ...
        float horizontal = Input.GetAxis("Horizontal", "Move");
        float vertical = Input.GetAxis("Vertical", "Move");
